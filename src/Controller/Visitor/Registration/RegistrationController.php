    ...
    public function register(
        ...
        ): Response
        {
            ...
            if ($form->isSubmitted() && $form->isValid()) 
            {
                ...
                $this->addFlash('success', 'Veillez vérifié votre compte, un email vous a été envoyé l\'adresse fourni lors de votre inscription.');
        ...
        public function emailVerif(User $user, string $token, UserRepository $userRepository): Response
        {
            ...
            {
                $this->addFlash('warning', 'Votre compte a dèjà été vérifié! Veuiller vous connecter.');
